...
import com.www.app.utils.Sign;
import com.www.app.utils.SystemTime;
import com.www.app.utils.Token;
...
//	private int timeout = 25000;// volley超时时间默认25秒
	...
	private static final int LOADINGIMAGE = R.mipmap.bg_loading_image;

	private static final int ERRORIMAGE = R.mipmap.image_view;
	...
	public NetAccess setParams3(Map<String, String> params) {
		params.put("time", SystemTime.getTime());
			...
			mImageLoader.get(url, new ImageListener() {
				...
				public void onResponse(ImageContainer response, boolean isImmediate) {
					...
					if (bitmap != null) {
						...
						imageview.setImageResource(R.mipmap.bg_loading_image);
					}
				}
